...
test:
	python3 -c "from tests.test_scanner import test_scan_missing_detects_korean_target_and_blank_target, test_scan_aligns_data_list_by_id_when_order_changes, test_scan_reports_missing_data_list_record; from tests.test_evaluation import test_gold_evaluation_passes_matching_provider, test_gold_evaluation_reports_quality_issues, test_eval_report_roundtrip; from tests.test_glossary import test_match_terms_uses_source_and_variants; from tests.test_lore import test_import_markdown_lore_cache_roundtrip_and_match, test_import_json_lore_uses_anchors, test_import_lore_directory_skips_readme; from tests.test_qa import test_qa_detects_placeholder_mismatch, test_qa_detects_traditional_and_length, test_qa_uses_path_specific_length_policy; from tests.test_terms import test_extract_term_candidates_excludes_known_glossary, test_rules_refiner_classifies_core_decisions, test_refined_terms_cache_roundtrip, test_get_term_refiner_resolves_supported_providers, test_promote_refined_terms_exports_only_confirmed_terms; from tests.test_translator import test_translate_appends_missing_data_list_record; from tests.test_state import test_translate_skips_locked_unit; from tests.test_context import test_translate_provider_receives_structured_context, test_context_includes_cross_file_similar_memory; test_scan_missing_detects_korean_target_and_blank_target(); test_scan_aligns_data_list_by_id_when_order_changes(); test_scan_reports_missing_data_list_record(); test_gold_evaluation_passes_matching_provider(); test_gold_evaluation_reports_quality_issues(); test_eval_report_roundtrip(); test_match_terms_uses_source_and_variants(); test_import_markdown_lore_cache_roundtrip_and_match(); test_import_json_lore_uses_anchors(); test_import_lore_directory_skips_readme(); test_qa_detects_placeholder_mismatch(); test_qa_detects_traditional_and_length(); test_qa_uses_path_specific_length_policy(); test_extract_term_candidates_excludes_known_glossary(); test_rules_refiner_classifies_core_decisions(); test_refined_terms_cache_roundtrip(); test_get_term_refiner_resolves_supported_providers(); test_promote_refined_terms_exports_only_confirmed_terms(); test_translate_appends_missing_data_list_record(); test_translate_skips_locked_unit(); test_translate_provider_receives_structured_context(); test_context_includes_cross_file_similar_memory(); print('direct unit tests passed')"
