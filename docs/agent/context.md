...
Limbus Translate 当前处于 v0.1 工具骨架阶段。仓库已通过 `ai-workspace-init` 初始化为 AI Workspace，并新增 Python CLI，用于扫描 LocalizeLimbusCompany 韩文资源与简中资源的缺译差异、同步 Paratranz 术语、生成 dry-run 翻译输出。
