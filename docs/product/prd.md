...
| 翻译上下文包 | 将同文件邻近文本、exact TM 示例和术语命中注入 provider context | 已完成轻量 ContextBundle 初版 |
...
| 翻译记忆 / RAG | 句段复用、相似上下文、世界观资料检索 | exact-match TM 和 ContextBundle/RAG 雏形已完成；fuzzy TM、世界观资料检索、向量检索未完成 |
