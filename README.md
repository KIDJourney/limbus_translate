...
- 候选译文缓存、request log 与 trace：provider 产物按 provider、source hash、context hash 和 glossary hash 缓存；每次 provider 入参可落 JSONL；每条译文记录 provenance，区分 state、TM、cache 和 provider。
